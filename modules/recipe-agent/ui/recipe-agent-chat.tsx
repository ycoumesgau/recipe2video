      ...
      <Tabs defaultValue="chat">
        ...
        <TabsContent className="mt-3" value="chat">
          <ReadonlyThreadProvider messages={threadMessages}>
            <ThreadPrimitive.Root className="flex max-h-[min(420px,55vh)] flex-col rounded-lg border bg-muted/10">
              <ThreadPrimitive.Viewport className="min-h-[200px] flex-1 p-2">
        ...
        <TabsContent className="mt-3" value="activity">
          <ScrollArea className="h-[min(320px,45vh)] rounded-lg border pr-3">
